...
if generate_btn and name and profile_pic:
    ...
    # Photo de profil très grande (3/4 de la largeur A5 à 300 DPI)
    profile_size = 1311
    border_size = 40
    ...
    # Créer cercle blanc comme vraie bordure ronde
    ...
    # Coller la photo dans le cercle
